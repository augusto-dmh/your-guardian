    ...
    <form class="max-w-lg pb-8">
        ...
        <div class="relative">
            ...
            <input type="search" name="searchTerm" value="{{ $searchTerm }}"
                class="block w-full p-4 text-white bg-opacity-50 border-none rounded-lg appearance-none bg-secondary-bg ps-10 focus:outline-none focus:ring-2 focus:ring-quinary-bg"
