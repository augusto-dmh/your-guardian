@props(['contentRowDirection' => false])
    ...
    <div x-data="mainState" x-on:resize.window="handleWindowResize" x-cloak>
        <div class="min-h-screen text-gray-200 bg-dark-eval-0">
            ...
            <div class="relative flex flex-col justify-between min-h-screen" {{-- :class="{
                ...
                <!-- Page Main Container -->
                <div class="{{ $contentRowDirection ? 'flex flex-col lg:flex-row items-center justify-center gap-8' : '' }} px-8 md:ml-16">
                    @if (session('success'))
                    ...
                    <!-- Page Content -->
                    <main>
                        <div class="{{ $contentRowDirection ? 'flex flex-col items-center justify-center gap-4' : '' }}">
                            {{ $slot }}
                        </div>
                    </main>
                </div>
