...
namespace Clockwork\Support\Laravel {
     ...
     */ class Facade
    {
         ...
         */ public static function resolveAsQueueJob(
            ...
            /** @var \Clockwork\Clockwork $instance */
            return $instance->resolveAsQueueJob(
                $name,
                $description,
                $status,
                $payload,
         ...
         *
         * @static
         */ public static function resolveAsTest(
            $name,
            $status = 'passed',
            $statusMessage = null,
            $asserts = []
...
namespace Spatie\LaravelIgnition\Facades {
     ...
     */ class Flare
    {
         ...
         *
         * @static
         */ public static function determineVersionUsing(
         ...
         *
         * @static
         */ public static function filterExceptionsUsing(
         ...
         *
         * @static
         */ public static function withStackFrameArguments(
            $withStackFrameArguments = true
        ) {
            /** @var \Spatie\FlareClient\Flare $instance */
